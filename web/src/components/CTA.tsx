      ...
      <div className="max-w-2xl mx-auto">
        <div className="bg-white shadow-2xl dark:bg-gray-900 rounded-lg p-10 border border-gray-800 dark:border-gray-700 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <a
              href="#download"
              className="inline-flex items-center justify-center gap-2 px-5 py-2.5 rounded-lg bg-gray-800 text-white hover:bg-gray-100 font-semibold transition-colors text-sm"
            >
              <Download size={18} />
              Download Now
            </a>
